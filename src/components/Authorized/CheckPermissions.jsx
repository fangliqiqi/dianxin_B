...
const checkPermissions = (authority, currentAuthority, target, Exception) => {
  ...
  if (Array.isArray(authority)) {
    ...
    if (Array.isArray(currentAuthority) && currentAuthority.some(item => authority.includes(item))) {
      return target;
    }
  ...
  if (typeof authority === 'string') {
    if (Array.isArray(currentAuthority) && currentAuthority.some(item => authority === item)) {
      return target;
    }
