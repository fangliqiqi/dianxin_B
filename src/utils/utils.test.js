...
const nestUserPath = '/nested/user';
...
describe('getRouteAuthority tests', () => {
  ...
  it('should return inherited authority for unconfigured route', () => {
    ...
    expect(getRouteAuthority(nestUserPath, routes)).toEqual(['admin', 'user']);
  });
  it('should return authority for configured route', () => {
    ...
    expect(getRouteAuthority(nestUserPath, routes)).toEqual(['user']);
  ...
  it('should return authority for substring route', () => {
    ...
    expect(getRouteAuthority(nestUserPath, routes)).toEqual(['user']);
    expect(getRouteAuthority(nestUserPath, routes)).toEqual(['users']);
  });
});
